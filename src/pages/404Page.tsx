...
export default function ErrorPage() {
  ...
  return (
    <main className="min-h-screen  bg-gradient-to-r from-gray-900  to-indigo-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-100  dark:text-gray-900">
